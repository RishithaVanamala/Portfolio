interface Obj {
  ...
  const Web: Obj[] = [
    ...
    {
      index: 2,
      src: "https://logos-download.com/wp-content/uploads/2024/01/Spring_Boot_Logo.svg",
      alt: "Springboot",
      width: "40",
    },    
    {
  ...
  const Other: Obj[] = [
    ...
    {
      index: 5,
      src: "https://raw.githubusercontent.com/devicons/devicon/master/icons/sentry/sentry-original-wordmark.svg",
      alt: "Sentry",
      width: "40",
    },
    {
