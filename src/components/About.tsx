    ...
    <>
      <GridDiv id="About">
        <LeftGrid>
          ...
          <LeftPara>
            Hi, I'm Rishitha Vanamala, a Computer Science graduate student at Syracuse University, with a CGPA of 3.96/4, graduating in May 2024. 
            My academic journey began with a Bachelor of Engineering in Computer Science from Osmania University, where I achieved a CGPA of 9.21/10. 
            I'm a tech enthusiast passionate about leveraging the latest technologies to address real-world challenges.
          </LeftPara>

          <LeftPara>
            My technical expertise spans a wide array of programming languages and technologies, including Python, Java, C++, Django, Spring Boot, ReactJS, AWS, and many more. 
          ...
          <LeftPara>
            I'm keen on exploring opportunities in Software Development, from Full Stack to Backend and Frontend roles, starting from May 2024. 
