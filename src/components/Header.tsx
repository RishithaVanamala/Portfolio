    ...
    <div className="block mt-4">
     <HeaderContainer>
      ...
      <SocialIconsContainer>
        <a href="https://www.linkedin.com/in/rishitha-vanamala/"className="linkedin-icon" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <FaLinkedin size={25} />
        </a>
        <a href="https://github.com/RishithaVanamala" className="github-icon" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          <FaGithub size={25} />
        </a>
      </SocialIconsContainer>
      <main>
...
<div className="order-1 md:order-2">
  <ProfileImgDiv>
  <ProfileImg
    alt="Rishitha Vanamala"
    src="https://ik.imagekit.io/5wqmnjnj5/Vanamala%20Rishitha?updatedAt=1708923097269"
  ...
  />
        ...
        <BtnDiv data-aos="fade-right" data-aos-duration="1000">
          <a href="https://drive.google.com/file/d/1djjGCDT8X45u2ivIDYqiHvyjZOBgVYEP/view?usp=sharing" target="_blank" onClick={ ()=>{ ReactGa.event({category: "Resume", action:"Downloaded Resume", label:"Test Label"})}} rel="noreferrer">
